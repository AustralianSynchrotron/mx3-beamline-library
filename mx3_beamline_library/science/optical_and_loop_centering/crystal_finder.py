...
from  mx3_beamline_library.schemas.xray_centering import SpotfinderResults
...
def _get_spotfinder_results(
    redis_connection:redis.StrictRedis, 
    sample_id: str, grid_scan_type: str, id: Union[bytes, int]
...
def _get_raster_grid_coordinates(
        ...
        redis.StrictRedis, 
        sample_id: str, 
        grid_scan_type: str) -> RasterGridMotorCoordinates:

...
class CrystalFinder:
    ...
    def __init__(self, number_of_spots: npt.NDArray, threshold: float, grid_scan_motor_coordinates: RasterGridMotorCoordinates = None) -> None:
        """
        Parameters
        ----------
    ...
    def _rectangle_coords(self, island_indices: set[tuple[int, int]]) -> CrystalPositions:
        """
    ...
    def _calculate_sample_x_coords(self, raster_grid_coords: RasterGridMotorCoordinates)  -> npt.NDArray:
        """
    ...
    def _calculate_sample_y_coords(self, raster_grid_coords: RasterGridMotorCoordinates)  -> npt.NDArray:
        """
...
class CrystalFinder3D:
    ...
    def vertices_list(
        self, coords_flat: list[CrystalPositions], coords_edge: list[CrystalPositions], coords_flat_index: int, coords_edge_index: int
    ):
        vertices_list = [
            (

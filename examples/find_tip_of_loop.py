"""
This examples shows how to find the tip of a loop, and determines 
where its grid coordinates lie for raster scanning
"""
...
loop_edge_detections = LoopEdgeDetection(image=SIM_MD3_CAMERA_IMG, block_size=35, adaptive_constant=3)
